...
object DatatypeConfig:
  ...
  val myCodecs: PartialFunction[String, Type => List[String]] = {
    ...
    case "sbt.librarymanagement.IvyPaths" => _ => "sbt.librarymanagement.IvyPathsFormats" :: Nil

    case "sbt.librarymanagement.LogicalClock" =>
      _ => "sbt.internal.librarymanagement.formats.LogicalClockFormats" :: Nil

    case "sbt.librarymanagement.CrossVersion" =>
      _ =>
    ...
    case "sbt.librarymanagement.ConfigRef" => _ => "sbt.librarymanagement.ConfigRefFormats" :: Nil
    ...
    case "scalajson.ast.unsafe.JValue" | "sjsonnew.shaded.scalajson.ast.unsafe.JValue" =>
      _ => "sbt.internal.util.codec.JValueFormats" :: Nil

    case "xsbti.HashedVirtualFileRef" =>
      _ => "sbt.internal.util.codec.HashedVirtualFileRefFormats" :: Nil

    case "java.nio.ByteBuffer" => _ => "sbt.internal.util.codec.ByteBufferFormats" :: Nil
    ...
    case "Int" | "Long" | "sbt.util.Digest" => _ => Nil
  }
