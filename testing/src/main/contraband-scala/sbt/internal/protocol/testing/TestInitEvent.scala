...
final class TestInitEvent private () extends sbt.internal.protocol.testing.TestMessage() with Serializable {
...
override def hashCode: Int = {
  37 * (17 + "sbt.internal.protocol.testing.TestInitEvent".##)
}
