...
final class EndTestGroupErrorEvent private (
  val name: String,
  val error: String) extends sbt.internal.protocol.testing.TestMessage() with Serializable {
  ...
  override def hashCode: Int = {
    37 * (37 * (37 * (17 + "sbt.internal.protocol.testing.EndTestGroupErrorEvent".##) + name.##) + error.##)
  }
