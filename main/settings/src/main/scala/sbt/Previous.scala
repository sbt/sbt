...
import Def.{ resolvedScoped, streamsManagerKey, Initialize, ScopedKey, Setting }
import Previous._
import Types._

import java.io.{ InputStream, OutputStream }
import sbinary.{ DefaultProtocol, Format }
import DefaultProtocol.{ withStamp, StringFormat }
...
object Previous {
  ...
  private[sbt] def cacheSetting = (streamsManagerKey, references) map { (s, refs) =>
