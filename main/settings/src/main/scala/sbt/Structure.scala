...
import Def.{ setting, Initialize, KeyedInitialize, ScopedKey, Setting }
import Path._
...
sealed abstract class SettingKey[T]
  ...
  final def append1[V](v: Initialize[V], source: SourcePosition)(implicit a: Append.Value[T, V]): Setting[T] =
  ...
  final def remove1[V](v: Initialize[V], source: SourcePosition)(implicit r: Remove.Value[T, V]): Setting[T] =
...
sealed abstract class TaskKey[T]
  ...
  private[this] def make[S](other: Initialize[Task[S]],
...
object Scoped {
  ...
  final class RichInitializeTask[S](i: Initialize[Task[S]]) extends RichInitTaskBase[S, Task] {
    ...
    def dependsOn(tasks: AnyInitTask*): Initialize[Task[S]] = (i, Initialize.joinAny[Task](tasks)) {
      (thisTask, deps) =>
  ...
  final class RichInitializeInputTask[S](i: Initialize[InputTask[S]]) extends RichInitTaskBase[S, InputTask] {
    ...
    def dependsOn(tasks: AnyInitTask*): Initialize[InputTask[S]] = (i, Initialize.joinAny[Task](tasks)) {
      (thisTask, deps) =>
  ...
  @deprecated(
    "The sbt 0.10 style DSL is deprecated: '(k1, k2) map { (x, y) => ... }' should now be '{ val x = k1.value; val y = k2.value }'.\nSee http://www.scala-sbt.org/0.13/docs/Migrating-from-sbt-012x.html"
  ) implicit def t2ToTable2[A, B](t2: (ScopedTaskable[A], ScopedTaskable[B])): RichTaskable2[A, B] =
  ...
  @deprecated(
    "The sbt 0.10 style DSL is deprecated: '(k1, k2) map { (x, y) => ... }' should now be '{ val x = k1.value; val y = k2.value }'.\nSee http://www.scala-sbt.org/0.13/docs/Migrating-from-sbt-012x.html"
      ...
      t4: (ScopedTaskable[A], ScopedTaskable[B], ScopedTaskable[C], ScopedTaskable[D])
  ): RichTaskable4[A, B, C, D] = new RichTaskable4(t4)
  @deprecated(
    "The sbt 0.10 style DSL is deprecated: '(k1, k2) map { (x, y) => ... }' should now be '{ val x = k1.value; val y = k2.value }'.\nSee http://www.scala-sbt.org/0.13/docs/Migrating-from-sbt-012x.html"
  ) implicit def t5ToTable5[A, B, C, D, E](
      t5: (ScopedTaskable[A], ScopedTaskable[B], ScopedTaskable[C], ScopedTaskable[D], ScopedTaskable[E])
  ): RichTaskable5[A, B, C, D, E] = new RichTaskable5(t5)
  @deprecated(
    "The sbt 0.10 style DSL is deprecated: '(k1, k2) map { (x, y) => ... }' should now be '{ val x = k1.value; val y = k2.value }'.\nSee http://www.scala-sbt.org/0.13/docs/Migrating-from-sbt-012x.html"
      ...
      t6: (ScopedTaskable[A],
           ...
           ScopedTaskable[E],
           ScopedTaskable[F])
  ): RichTaskable6[A, B, C, D, E, F] = new RichTaskable6(t6)
  @deprecated(
    "The sbt 0.10 style DSL is deprecated: '(k1, k2) map { (x, y) => ... }' should now be '{ val x = k1.value; val y = k2.value }'.\nSee http://www.scala-sbt.org/0.13/docs/Migrating-from-sbt-012x.html"
      ...
      t7: (ScopedTaskable[A],
           ...
           ScopedTaskable[F],
           ScopedTaskable[G])
  ): RichTaskable7[A, B, C, D, E, F, G] = new RichTaskable7(t7)
  @deprecated(
    "The sbt 0.10 style DSL is deprecated: '(k1, k2) map { (x, y) => ... }' should now be '{ val x = k1.value; val y = k2.value }'.\nSee http://www.scala-sbt.org/0.13/docs/Migrating-from-sbt-012x.html"
      ...
      t8: (ScopedTaskable[A],
           ...
           ScopedTaskable[G],
           ScopedTaskable[H])
  ): RichTaskable8[A, B, C, D, E, F, G, H] = new RichTaskable8(t8)
  @deprecated(
    "The sbt 0.10 style DSL is deprecated: '(k1, k2) map { (x, y) => ... }' should now be '{ val x = k1.value; val y = k2.value }'.\nSee http://www.scala-sbt.org/0.13/docs/Migrating-from-sbt-012x.html"
      ...
      t9: (ScopedTaskable[A],
           ...
           ScopedTaskable[H],
           ScopedTaskable[I])
  ): RichTaskable9[A, B, C, D, E, F, G, H, I] = new RichTaskable9(t9)
  @deprecated(
    "The sbt 0.10 style DSL is deprecated: '(k1, k2) map { (x, y) => ... }' should now be '{ val x = k1.value; val y = k2.value }'.\nSee http://www.scala-sbt.org/0.13/docs/Migrating-from-sbt-012x.html"
      ...
      t10: (ScopedTaskable[A],
            ...
            ScopedTaskable[I],
            ScopedTaskable[J])
  ): RichTaskable10[A, B, C, D, E, F, G, H, I, J] = new RichTaskable10(t10)
  @deprecated(
    "The sbt 0.10 style DSL is deprecated: '(k1, k2) map { (x, y) => ... }' should now be '{ val x = k1.value; val y = k2.value }'.\nSee http://www.scala-sbt.org/0.13/docs/Migrating-from-sbt-012x.html"
      ...
      t11: (ScopedTaskable[A],
            ...
            ScopedTaskable[J],
            ScopedTaskable[K])
  ): RichTaskable11[A, B, C, D, E, F, G, H, I, J, K] = new RichTaskable11(t11)
  ...
  final class RichTaskable5[A, B, C, D, E](t5: (ST[A], ST[B], ST[C], ST[D], ST[E]))
      extends RichTaskables[AList.T5K[A, B, C, D, E]#l](t5)(AList.tuple5[A, B, C, D, E]) {
    type Fun[M[_], Ret] = (M[A], M[B], M[C], M[D], M[E]) => Ret
    def identityMap = map(mkTuple5)
    protected def convert[M[_], R](f: Fun[M, R]) = f.tupled
  }
  final class RichTaskable6[A, B, C, D, E, F](t6: (ST[A], ST[B], ST[C], ST[D], ST[E], ST[F]))
      extends RichTaskables[AList.T6K[A, B, C, D, E, F]#l](t6)(AList.tuple6[A, B, C, D, E, F]) {
    type Fun[M[_], Ret] = (M[A], M[B], M[C], M[D], M[E], M[F]) => Ret
    def identityMap = map(mkTuple6)
    protected def convert[M[_], R](z: Fun[M, R]) = z.tupled
  }
  final class RichTaskable7[A, B, C, D, E, F, G](t7: (ST[A], ST[B], ST[C], ST[D], ST[E], ST[F], ST[G]))
      extends RichTaskables[AList.T7K[A, B, C, D, E, F, G]#l](t7)(AList.tuple7[A, B, C, D, E, F, G]) {
  ...
  ) extends RichTaskables[AList.T8K[A, B, C, D, E, F, G, H]#l](t8)(AList.tuple8[A, B, C, D, E, F, G, H]) {
  ...
  final class RichTaskable11[A, B, C, D, E, F, G, H, I, J, K](
      t11: ((ST[A], ST[B], ST[C], ST[D], ST[E], ST[F], ST[G], ST[H], ST[I], ST[J], ST[K]))
  ...
  @deprecated(
    "The sbt 0.10 style DSL is deprecated: '(k1, k2) map { (x, y) => ... }' should now be '{ val x = k1.value; val y = k2.value }'.\nSee http://www.scala-sbt.org/0.13/docs/Migrating-from-sbt-012x.html"
      ...
      t5: (Initialize[A], Initialize[B], Initialize[C], Initialize[D], Initialize[E])
  ): Apply5[A, B, C, D, E] = new Apply5(t5)
  @deprecated(
    "The sbt 0.10 style DSL is deprecated: '(k1, k2) map { (x, y) => ... }' should now be '{ val x = k1.value; val y = k2.value }'.\nSee http://www.scala-sbt.org/0.13/docs/Migrating-from-sbt-012x.html"
  ) implicit def t6ToApp6[A, B, C, D, E, F](
      t6: (Initialize[A], Initialize[B], Initialize[C], Initialize[D], Initialize[E], Initialize[F])
  ): Apply6[A, B, C, D, E, F] = new Apply6(t6)
  @deprecated(
    "The sbt 0.10 style DSL is deprecated: '(k1, k2) map { (x, y) => ... }' should now be '{ val x = k1.value; val y = k2.value }'.\nSee http://www.scala-sbt.org/0.13/docs/Migrating-from-sbt-012x.html"
      ...
      t7: (Initialize[A],
           ...
           Initialize[F],
           Initialize[G])
  ): Apply7[A, B, C, D, E, F, G] = new Apply7(t7)
  @deprecated(
    "The sbt 0.10 style DSL is deprecated: '(k1, k2) map { (x, y) => ... }' should now be '{ val x = k1.value; val y = k2.value }'.\nSee http://www.scala-sbt.org/0.13/docs/Migrating-from-sbt-012x.html"
      ...
      t8: (Initialize[A],
           ...
           Initialize[G],
           Initialize[H])
  ): Apply8[A, B, C, D, E, F, G, H] = new Apply8(t8)
  @deprecated(
    "The sbt 0.10 style DSL is deprecated: '(k1, k2) map { (x, y) => ... }' should now be '{ val x = k1.value; val y = k2.value }'.\nSee http://www.scala-sbt.org/0.13/docs/Migrating-from-sbt-012x.html"
      ...
      t9: (Initialize[A],
           ...
           Initialize[H],
           Initialize[I])
  ): Apply9[A, B, C, D, E, F, G, H, I] = new Apply9(t9)
  @deprecated(
    "The sbt 0.10 style DSL is deprecated: '(k1, k2) map { (x, y) => ... }' should now be '{ val x = k1.value; val y = k2.value }'.\nSee http://www.scala-sbt.org/0.13/docs/Migrating-from-sbt-012x.html"
      ...
      t10: (Initialize[A],
            ...
            Initialize[I],
            Initialize[J])
  ): Apply10[A, B, C, D, E, F, G, H, I, J] = new Apply10(t10)
  @deprecated(
    "The sbt 0.10 style DSL is deprecated: '(k1, k2) map { (x, y) => ... }' should now be '{ val x = k1.value; val y = k2.value }'.\nSee http://www.scala-sbt.org/0.13/docs/Migrating-from-sbt-012x.html"
      ...
      t11: (Initialize[A],
            ...
            Initialize[J],
            Initialize[K])
  ): Apply11[A, B, C, D, E, F, G, H, I, J, K] = new Apply11(t11)
  ...
  def mkTuple14[A, B, C, D, E, F, G, H, I, J, K, L, N, O] =
    (a: A, b: B, c: C, d: D, e: E, f: F, g: G, h: H, i: I, j: J, k: K, l: L, n: N, o: O) =>
      (a, b, c, d, e, f, g, h, i, j, k, l, n, o)
  def mkTuple15[A, B, C, D, E, F, G, H, I, J, K, L, N, O, P] =
    (a: A, b: B, c: C, d: D, e: E, f: F, g: G, h: H, i: I, j: J, k: K, l: L, n: N, o: O, p: P) =>
  ...
  final class Apply6[A, B, C, D, E, F](
    ...
    def apply[T](z: (A, B, C, D, E, F) => T) =
      Def.app[AList.T6K[A, B, C, D, E, F]#l, T](t6)(z.tupled)(AList.tuple6[A, B, C, D, E, F])
  ...
  final class Apply7[A, B, C, D, E, F, G](
    ...
    def apply[T](z: (A, B, C, D, E, F, G) => T) =
      Def.app[AList.T7K[A, B, C, D, E, F, G]#l, T](t7)(z.tupled)(AList.tuple7[A, B, C, D, E, F, G])
  ...
  final class Apply8[A, B, C, D, E, F, G, H](
    ...
    def apply[T](z: (A, B, C, D, E, F, G, H) => T) =
      Def.app[AList.T8K[A, B, C, D, E, F, G, H]#l, T](t8)(z.tupled)(AList.tuple8[A, B, C, D, E, F, G, H])
  ...
  final class Apply9[A, B, C, D, E, F, G, H, I](
    ...
    def apply[T](z: (A, B, C, D, E, F, G, H, I) => T) =
      Def.app[AList.T9K[A, B, C, D, E, F, G, H, I]#l, T](t9)(z.tupled)(AList.tuple9[A, B, C, D, E, F, G, H, I])
