...
object Keys {
  ...
  val javaScalaCompiler = TaskKey[MixedAnalyzingCompiler => (Set[File], DependencyChanges, xsbti.AnalysisCallback) => Unit]("javaScalaCompiler", "Compiles Java and Scala sources", DTask)
