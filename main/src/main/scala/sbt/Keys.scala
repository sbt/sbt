...
object Keys {
  ...
  @deprecated("Use `scalaApiURL` and `javaApiURL` for scala and java API documentation URL respectively.", "0.13.8")
  val apiURL = SettingKey[Option[URL]]("api-url", "Base URL for API documentation.", BMinusSetting)
  val scalaApiURL = SettingKey[Option[URL]]("scala-api-url", "Base URL for Scala API documentation.", BMinusSetting)
  val javaApiURL = SettingKey[Option[URL]]("java-api-url", "Base URL for Java API documentation.", BMinusSetting)
  val scalaEntryApiURL = AttributeKey[URL]("scala-entry-api-url", "Base URL for the Scala API documentation for a classpath entry.")
  val javaEntryApiURL = AttributeKey[URL]("java-entry-api-url", "Base URL for the Java API documentation for a classpath entry.")
  @deprecated("Use `scalaApiMappings` and `javaApiMappings` for scala and java classpath entry to API documentation URL respectively.", "0.13.8")
  ...
  val scalaApiMappings = TaskKey[Map[File, URL]]("api-mappings", "Mappings from classpath entry to API documentation base URL.", BMinusSetting)
  val javaApiMappings = TaskKey[Map[File, URL]]("api-mappings", "Mappings from classpath entry to API documentation base URL.", BMinusSetting)
