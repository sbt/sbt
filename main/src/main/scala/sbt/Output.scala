...
object Output {
  ...
  def last(keys: Values[_], streams: Streams, printLines: Seq[String] => Unit, sid: Option[String])(
      implicit display: Show[ScopedKey[_]]
  ): Unit =
  ...
  def lastGrep(keys: Values[_], streams: Streams, patternString: String, printLines: Seq[String] => Unit)(
      implicit display: Show[ScopedKey[_]]
  ): Unit = {
  ...
  def flatLines(
      outputs: Values[Seq[String]]
  )(f: Seq[String] => Seq[String])(implicit display: Show[ScopedKey[_]]): Seq[String] = {
