...
import java.nio.file.{ Files, FileSystemException, NoSuchFileException, Path as NioPath }
  ...
  private[sbt] def extractAnalysis(
    ...
    def getContents(ref: VirtualFileRef): Option[AnalysisContents] =
      ...
      try
        ...
        case _: NoSuchFileException => fallback(file)
        case _: FileSystemException => fallback(file)
    for
  ...
  private class CachedAnalysisStore(path: NioPath, converter: FileConverter) extends AnalysisStore:
    ...
    override def get: Optional[AnalysisContents] =
      ...
      try
        ...
        case _: NoSuchFileException => underlying.get
        case _: FileSystemException => underlying.get
