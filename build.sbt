...
val completeProj = (project in file("internal") / "util-complete")
  ...
  .configure(addSbtIO, addSbtZincControl)
...
lazy val testingProj = (project in file("testing"))
  ...
  .configure(addSbtIO, addSbtLmLogging, addSbtCompilerClasspath)
...
lazy val stdTaskProj = (project in file("tasks-standard"))
  ...
  .configure(addSbtIO, addSbtLmLogging, addSbtLmCache)
...
lazy val scriptedSbtProj = (project in scriptedPath / "sbt")
  ...
  .configure(addSbtIO, addSbtLmLogging, addSbtCompilerInterface, addSbtZincUtilScripted)
