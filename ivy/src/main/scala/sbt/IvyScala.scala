    ...
    if (isDotty)
      Seq(
        ModuleID(
          ...
          DottyIDPrefix,
          version,
          Some(Configurations.ScalaTool.name + "->default(compile)"),
...
final case class IvyScala(scalaFullVersion: String,
...
private object IvyScala {
  ...
  def checkModule(module: DefaultModuleDescriptor,
                  conf: String,
                  scalaVersionConfigs: Vector[String],
                  log: Logger)(check: IvyScala): Unit = {
  ...
  class OverrideScalaMediator(scalaOrganization: String,
                              scalaVersion: String,
  ...
  def overrideScalaVersion(module: DefaultModuleDescriptor,
                           organization: String,
                           version: String,
                           scalaVersionConfigs: Vector[String]): Unit = {
  ...
  /**
    ...
    */
  private def checkDependencies(module: ModuleDescriptor,
  ...
  private def excludeScalaJars(module: DefaultModuleDescriptor,
                               configurations: Iterable[Configuration]): Unit = {
  ...
  /**
    ...
    */
  private[sbt] def excludeRule(organization: String,
                               name: String,
                               configurationNames: Iterable[String],
                               excludeTypePattern: String): ExcludeRule = {
