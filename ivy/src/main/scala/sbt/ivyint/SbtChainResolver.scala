...
import org.apache.ivy.plugins.resolver.{ MavenRepositoryResolver, ChainResolver, BasicResolver, DependencyResolver }
        ...
        if (useLatest) (foundRevisions.sortBy {
          ...
          case (rmr, resolver) =>
            ...
            artifactOpt match {
              ...
              case None if resolver.isInstanceOf[MavenRepositoryResolver] =>
              // do nothing for now....
