...
import core.module.descriptor.{ DefaultDependencyArtifactDescriptor, DependencyArtifactDescriptor }
...
private[sbt] final case class MergedDescriptors(a: DependencyDescriptor, b: DependencyDescriptor)
  ...
  private[this] def concatArtifacts(a: DependencyDescriptor,
  ...
  private[this] def explicitConfigurations(base: DependencyDescriptor,
                                           art: DependencyArtifactDescriptor): DependencyArtifactDescriptor = {
  ...
  private[this] def defaultArtifact(a: DependencyDescriptor): Array[DependencyArtifactDescriptor] = {
    val dd =
      new DefaultDependencyArtifactDescriptor(a, a.getDependencyRevisionId.getName, "jar", "jar", null, null)
  ...
  private[this] def copyWithConfigurations(dd: DependencyArtifactDescriptor,
                                           confs: Seq[String]): DependencyArtifactDescriptor = {
  ...
  def doesExclude(moduleConfigurations: Array[String], artifactId: ArtifactId) =
    a.doesExclude(moduleConfigurations, artifactId) || b.doesExclude(moduleConfigurations, artifactId)
