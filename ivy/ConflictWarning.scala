...
{
	def default(label: String): ConflictWarning = ConflictWarning(label, moduleFilter(organization = GlobFilter("org.scala-sbt") | GlobFilter("org.scala-lang")), (_: ModuleID).organization, Level.Warn, false)
