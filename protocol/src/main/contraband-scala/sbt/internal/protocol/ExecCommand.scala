...
final class ExecCommand private (
  ...
  val execId: Option[String]) extends sbt.internal.protocol.CommandMessage() with Serializable {
  ...
  override def hashCode: Int = {
    37 * (37 * (37 * (17 + "sbt.internal.protocol.ExecCommand".##) + commandLine.##) + execId.##)
  }
