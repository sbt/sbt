...
final class SettingQuerySuccess private (
  ...
  val contentType: String) extends sbt.internal.protocol.SettingQueryResponse() with Serializable {
  ...
  override def hashCode: Int = {
    37 * (37 * (37 * (17 + "sbt.internal.protocol.SettingQuerySuccess".##) + value.##) + contentType.##)
  }
