...
final class ExecStatusEvent private (
  ...
  val commandQueue: Vector[String]) extends sbt.internal.protocol.EventMessage() with Serializable {
  ...
  override def hashCode: Int = {
    37 * (37 * (37 * (37 * (37 * (17 + "sbt.internal.protocol.ExecStatusEvent".##) + status.##) + channelName.##) + execId.##) + commandQueue.##)
  }
