...
libraryDependencies ++= Seq(
  "io.get-coursier" %% "coursier" % "1.0.0-RC14",
  "io.get-coursier" %% "coursier-cache" % "1.0.0-RC14"
)
```
...
```
$ ./coursier bootstrap \
    io.get-coursier:coursier-cli_2.11:1.0.0-RC14 \
    -b -f -o coursier \
...
The first module, `"io.get-coursier" %% "coursier" % "1.0.0-RC14"`, mainly depends on
...
The second module, `"io.get-coursier" %% "coursier-cache" % "1.0.0-RC14"`, is precisely in charge of fetching
