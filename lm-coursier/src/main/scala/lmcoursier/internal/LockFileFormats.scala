...
trait ArtifactLockFormats:
  ...
  given ArtifactLockFormat: JsonFormat[ArtifactLock] = new JsonFormat[ArtifactLock]:
    ...
    override def write[J](obj: ArtifactLock, builder: Builder[J]): Unit =
      ...
      builder.endObject()
end ArtifactLockFormats

trait DependencyLockFormats:
  self: sjsonnew.BasicJsonProtocol & ArtifactLockFormats =>
