...
object AList {
  ...
  val empty: Empty = new Empty {
    ...
    def traverse[M[_], N[_], P[_]](in: Unit, f: M ~> (N ∙ P)#l)(implicit np: Applicative[N]): N[Unit] =
      np.pure(())
  }
  ...
  def klist[KL[M[_]] <: KList[M] { type Transform[N[_]] = KL[N] }]: AList[KL] = new AList[KL] {
    ...
    def traverse[M[_], N[_], P[_]](k: KL[M], f: M ~> (N ∙ P)#l)(implicit np: Applicative[N]): N[KL[P]] =
      k.traverse[N, P](f)(np)
  ...
  def asplit[K[L[x]], B[x]](base: AList[K]): ASplit[K, B] = new ASplit[K, B] {
    ...
    def traverse[M[_], N[_], P[_]](value: Split[M],
                                   f: M ~> (N ∙ P)#l)(implicit np: Applicative[N]): N[Split[P]] = {
  ...
  def tuple10[A, B, C, D, E, F, G, H, I, J]: T10List[A, B, C, D, E, F, G, H, I, J] =
    new T10List[A, B, C, D, E, F, G, H, I, J] {
      ...
      def foldr[M[_], T](t: T10[M], f: (M[_], T) => T, init: T): T =
        f(t._1, f(t._2, f(t._3, f(t._4, f(t._5, f(t._6, f(t._7, f(t._8, f(t._9, f(t._10, init))))))))))
  ...
  def tuple11[A, B, C, D, E, F, G, H, I, J, K]: T11List[A, B, C, D, E, F, G, H, I, J, K] =
    new T11List[A, B, C, D, E, F, G, H, I, J, K] {
      ...
      def transform[M[_], N[_]](t: T11[M], f: M ~> N) =
        (f(t._1), f(t._2), f(t._3), f(t._4), f(t._5), f(t._6), f(t._7), f(t._8), f(t._9), f(t._10), f(t._11))
      def foldr[M[_], T](t: T11[M], f: (M[_], T) => T, init: T): T =
        f(
          t._1,
          f(t._2, f(t._3, f(t._4, f(t._5, f(t._6, f(t._7, f(t._8, f(t._9, f(t._10, f(t._11, init))))))))))
        )
