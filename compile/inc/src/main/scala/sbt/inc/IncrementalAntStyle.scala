...
private final class IncrementalAntStyle(log: Logger, options: IncOptions)
  ...
  override protected def invalidateByExternal(relations: Relations,
                                              externalAPIChange: APIChange[String]): Set[File] = Set.empty
