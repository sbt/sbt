...
Use `testTopology` setting to control wheather you want to split the test classes into multiple workers or keep them together. The default was changed to split to 2 groups:
...
sbt 2.1.0 updates the Scala version used by the metabuild to 3.9.0.
...
- fix: Resolve `Seq[Initialize[Task[T]]].join` to `Initialize[Task[Seq[T]]]` by @jozanek in https://github.com/sbt/sbt/pull/9347
- fix: Forward `build.sbt` compilation errors to logger by @eed3si9n in https://github.com/sbt/sbt/pull/9599
- fix: Fixes cache invalidation on version change by @eed3si9n in https://github.com/sbt/sbt/pull/9471
- fix: sbtn to retry on corrupt `active.json` by @eed3si9n in https://github.com/sbt/sbt/pull/9617
- fix: hash action cache inputs with full-width sha256 by @stasimus in https://github.com/sbt/sbt/pull/9641
- fix: Verify remote cache blobs against their digest by @stasimus in https://github.com/sbt/sbt/pull/9643
- fix: Populate the in-memory cache on a read by @hoangmaihuy in https://github.com/sbt/sbt/pull/9657
- fix: Fixes sbt-native-packager compatibility by @xuwei-k in https://github.com/sbt/sbt/pull/9677
- fix: Remove `global.base` setting in Windows runner script by @vlovgr in https://github.com/sbt/sbt/pull/9688
- fix: Share a holder for a closeable by @kitbellew in https://github.com/sbt/sbt/pull/9692
- fix: Retry a read before discarding a server by @kitbellew in https://github.com/sbt/sbt/pull/9690
- fix: Write the server's files by rename by @kitbellew in https://github.com/sbt/sbt/pull/9689
- fix: keep every output line the runner test reads by @stasimus in https://github.com/sbt/sbt/pull/9687
...
- fix: Keep macro subprojects off the pipelined classpath by @stasimus in https://github.com/sbt/sbt/pull/9719
- fix: Restart the sbt server when `-D` options change by @stasimus in https://github.com/sbt/sbt/pull/9685
- fix: Keep accepting after a client fails by @kitbellew in https://github.com/sbt/sbt/pull/9691
- fix: Add a row when `customRow` gets no versions by @kitbellew in https://github.com/sbt/sbt/pull/9717
- fix: Remove Ivy API usage from build publishing plugins by @anatoliykmetyuk in https://github.com/sbt/sbt/pull/9723
- fix: Fail the build on bad resource generator by @eed3si9n in https://github.com/sbt/sbt/pull/9735
- fix: Fixes cross command parsing by @stasimus in https://github.com/sbt/sbt/pull/9726
- fix: Stop a displaced server by @kitbellew in https://github.com/sbt/sbt/pull/9713
- fix: Resolve the project axis to the current project in `runAggregated` by @jozanek in https://github.com/sbt/sbt/pull/9722
...
- refactor: Fix warning in ivyless-publish-http-plugin test by @xuwei-k in https://github.com/sbt/sbt/pull/9597
- ci: Update sbt and plugins by @xuwei-k in https://github.com/sbt/sbt/pull/9603
- test: Add a regression test for incremental test by @eed3si9n in https://github.com/sbt/sbt/pull/9608
- Remove Ivy dependency by @eed3si9n in https://github.com/sbt/sbt/pull/9615
- test: Cover action cache traversal and content guards by @stasimus in https://github.com/sbt/sbt/pull/9640
- test: Community Build by @eed3si9n in https://github.com/sbt/sbt/pull/9659
- Symlink CLAUDE.md to AGENTS.md by @eed3si9n in https://github.com/sbt/sbt/pull/9663
...
- ci: Bump actions/setup-java from 5 to 6 by @dependabot in https://github.com/sbt/sbt/pull/9695
...
**Full Changelog**: https://github.com/sbt/sbt/compare/f97633075960aaacd9e571461a688a000ed5ba0d...fe56804cd752800490dfe56533040558d01263c5
