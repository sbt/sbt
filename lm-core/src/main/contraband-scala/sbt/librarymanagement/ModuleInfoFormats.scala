...
trait ModuleInfoFormats { self: sbt.librarymanagement.LicenseInfoFormats with sjsonnew.BasicJsonProtocol with sbt.librarymanagement.ScmInfoFormats with sbt.librarymanagement.DeveloperFormats =>
