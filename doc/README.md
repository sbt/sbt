...
```
$ ./coursier bootstrap \
    io.get-coursier:coursier-cli_2.11:1.0.0-RC4 \
    -b -f -o coursier \
...
The first module, `"io.get-coursier" %% "coursier" % "1.0.0-RC4"`, mainly depends on
...
The second module, `"io.get-coursier" %% "coursier-cache" % "1.0.0-RC4"`, is precisely in charge of fetching
