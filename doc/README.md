...
```scala
addSbtPlugin("com.github.alexarchambault" % "coursier-sbt-plugin" % "1.0.0-M5")
```
...
```
$ ./coursier bootstrap \
    com.github.alexarchambault:coursier-cli_2.11:1.0.0-M5 \
    -b -f -o coursier \
...
The first module, `"com.github.alexarchambault" %% "coursier" % "1.0.0-M5"`, mainly depends on
...
The second module, `"com.github.alexarchambault" %% "coursier-cache" % "1.0.0-M5"`, is precisely in charge of fetching
